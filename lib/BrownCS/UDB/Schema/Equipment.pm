...
__PACKAGE__->add_columns(
  ...
  "equip_usage"       => { data_type => "text", default_value => undef, is_nullable => 0, size => undef, },
  "installed_on"      => { data_type => "date", default_value => undef, is_nullable => 1, size => 4 },
  "last_contacted_on" => { data_type => "date", default_value => undef, is_nullable => 1, size => 4 },
...
__PACKAGE__->belongs_to("equip_usage", "BrownCS::UDB::Schema::EquipUsageTypes", { name => "equip_usage" },);
